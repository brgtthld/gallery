<div class="container-fluid">
                        ...
                        <a href="?page=Gallery_tambah" class="btn btn-primary">+ Tambah Galeri</a>
                        <br><br>
                        <table class="table table-bordered">
                            ...
                            <a href="?page=Gallery_ubah&&id=<?php echo $data['id_foto']; ?>" class="btn btn-primary">Ubah</a>
                            <a href="?page=Gallery_hapus&&id=<?php echo $data['id_foto']; ?>" class="btn btn-danger">Hapus</a>
